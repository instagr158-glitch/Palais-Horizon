...
export const fr: Dict = {
  ...
  paris: {
    navLabel: "Appartements",
    badge: "Location à Paris",
    titleLead: "Trouvez votre appartement à Paris",
    ...
    step2Title: "Comparez",
    step2Body: "Loyer, surface et prix au m² côte à côte pour repérer le meilleur prix.",
    step3Title: "Contactez l'agence",
    step3Body: "Un clic et vous êtes sur l'annonce, directement chez l'agence.",
    filterAll: "Tous",
    filterUnder: "Moins de 1 200 €",
    filterMid: "1 200 – 2 000 €",
    filterPremium: "Haut de gamme",
  ...
  invest: {
    ...
    step1Title: "Choisissez un bien",
    step1Body: "Photos, prix de la part et rendement affiché.",
    step2Title: "Achetez des parts",
    step2Body: "Dès 50 $, directement auprès de la plateforme.",
    step3Title: "Recevez votre part des loyers",
    step3Body: "Versée dès que le bien génère des loyers.",
  ...
  pricing: {
    ...
    features: [
      ...
      "Filtres par budget, tri et favoris",
      "Nouveaux appartements dès leur arrivée",
    ],
    notConfigured:
    ...
    lockedPartsBanner:
      "Les annonces sont réservées aux membres. Choisissez une formule ci-dessous pour y accéder.",
    lockedBanner:
