...
export const fr: Dict = {
  ...
  landing: {
    ...
    heroTitleTrail: "",
    heroSubtext:
      "Palais Horizon analyse en continu les annonces de toutes les agences pour repérer les meilleurs prix.",
    ...
    baliHighlightTitle: "Bali - l'île des dieux",
    highlightCta: "Voir les annonces",
  ...
  invest: {
    badge: "Acheter des parts à Miami",
    title: "Acheter des parts de biens locatifs à Miami",
    subtitle: "Nous rassemblons des offres pour acheter des parts de biens locatifs, ou un appartement entier, à Miami. Vous achetez directement auprès de la plateforme ou de l'agence, vers lesquelles nous vous redirigeons : nous ne collectons jamais votre argent.",
    fractionalTitle: "Commencer petit : des parts de biens locatifs",
    fractionalBody: "Les plateformes de parts fractionnées permettent d'acheter des parts de biens locatifs et de recevoir une partie des loyers.",
    directTitle: "Acheter un appartement qui autorise la location courte durée",
    directBody: "Certains immeubles de Miami autorisent les séjours de type Airbnb. Les règles varient d'un immeuble à l'autre et évoluent : vérifiez toujours avant d'acheter.",
    minLabel: "Minimum",
    incomeLabel: "Revenus",
    ark7Desc: "Détenez des parts de biens locatifs. Des biens à Miami sont proposés dans l'application Ark7 (disponibilités variables).",
    ark7Min: "20 $ par part",
    arrivedDesc: "Parts de maisons locatives et de locations saisonnières dans plusieurs États américains. Vérifiez les disponibilités actuelles en Floride.",
    arrivedMin: "100 $",
    income: "Distributions mensuelles, non garanties",
    visitAt: "Acheter des parts chez",
    ruleDaily: "Location à la journée autorisée",
    rule90: "Séjour de 90 jours minimum, 4 fois par an maximum",
    buildingsSource: "Règles des immeubles selon CondoBlackBook, relevées le 25 septembre 2026. Elles peuvent changer : confirmez auprès de l'immeuble avant d'acheter.",
    fullList: "Voir la liste complète chez CondoBlackBook",
    disclaimerTitle: "Important",
    disclaimer: "Palais Horizon est un index d'informations de tiers. Ceci n'est pas un conseil en investissement. Tout investissement comporte un risque de perte partielle ou totale du capital, et les résultats passés ne préjugent pas des résultats futurs. Nous ne collectons aucun fonds, ne promettons aucun rendement et ne participons à aucune transaction : vérifiez les conditions directement auprès de la plateforme ou de l'agence.",
    updated: "Informations relevées le 25 septembre 2026.",
    bannerTitle: "Nouveau : achetez des parts de biens locatifs à Miami",
    bannerBody: "De vraies opportunités, sans abonnement. Nous vous redirigeons vers la plateforme ou l'agence.",
    bannerCta: "Découvrir",
    catalogueTitle: "Les meilleures opportunités à acheter, classées par rendement estimé",
    catalogueBody: "De vrais appartements du centre de Miami, actuellement en vente. Pour chacun, nous estimons le rendement locatif brut à partir des loyers demandés pour des logements comparables du même immeuble ou du même code postal.",
    topBadge: "Meilleur rendement",
    priceLabel: "Prix",
    estRentLabel: "Loyer mensuel estimé",
    yieldLabel: "Rendement brut estimé",
    rangeLabel: "Fourchette",
    confidenceLabel: "Fiabilité de l'estimation",
    confidenceHigh: "Bonne",
    confidenceMedium: "Moyenne",
    confidenceLow: "Faible",
    basisBuilding: "Basé sur {n} loyers demandés comparables ({beds} ch.) dans « {place} »",
    basisZip: "Basé sur {n} loyers demandés comparables ({beds} ch.) dans le code postal {place}",
    yieldVsMedian: "Médiane du catalogue : {median} % ({diff} pt)",
    pricePerSqm: "Prix au m² : {value}",
    pricePerSqmVs: "{pct} % par rapport à la médiane du catalogue",
    bedsShort: "ch.",
    bathsShort: "sdb",
    viewListing: "Voir l'annonce chez l'agence",
    caveat: "Estimation brute, avant charges de copropriété, taxe foncière, assurance, vacance locative et frais. Elle repose sur des loyers demandés, pas sur des revenus réalisés, et ne dit rien de la location courte durée (Airbnb), dont les règles varient d'un immeuble à l'autre : vérifiez-les avant d'acheter.",
    methodTitle: "Comment nous calculons",
    methodBody: "Le loyer estimé est la médiane des loyers demandés pour des logements comparables (même nombre de chambres) du même immeuble ou, à défaut, du même code postal, tirés des annonces de notre catalogue. Le rendement brut est le loyer annuel divisé par le prix d'achat. Seuls les biens avec au moins 3 comparables sont classés, et les résultats supérieurs à 12 %, peu réalistes, sont écartés.",
  },
  ...
  pricing: {
    ...
    unlockTagline: "Recherche de biens immobiliers",
