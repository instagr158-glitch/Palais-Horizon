...
export const fr: Dict = {
  ...
  invest: {
    ...
    fractionalBody: "Vous achetez des parts d'un bien locatif (y compris des locations saisonnières) et vous recevez une partie de ses loyers. Commencez avec 100 $, 500 $ ou plus, répartissez sur plusieurs biens, et regardez ce que chaque plateforme propose à Miami.",
    minLabel: "Minimum",
    incomeLabel: "Revenus",
    ...
    usOnlyEligibility: "Résidents américains uniquement",
    eligibilityLabel: "Qui peut acheter",
    openBadge: "Ouvert au monde entier",
    usBadge: "Résidents US uniquement",
