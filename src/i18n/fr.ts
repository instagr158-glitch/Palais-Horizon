...
export const fr: Dict = {
  ...
  pricing: {
    ...
    features: [
      "Achat de parts pour moins de 50 $ dans plus de 15 biens (Miami, Floride, Airbnb…)",
      "Accès direct aux biens : un clic pour acheter vos parts",
      "Rendements actuels et nombre d'investisseurs par bien",
      "Catalogue complet des résidences : Thaïlande, Bali, Dubaï, Miami",
      "Prix, localisations exactes, carte et galeries photo complètes",
      "Mise en relation directe avec l'agence",
      "Recherches et filtres illimités, favoris",
      "Nouveaux biens et nouvelles opportunités dès leur arrivée",
    ],
    notConfigured:
