...
export const fr: Dict = {
  ...
  landing: {
    ...
    showcaseSaleTitle: "Acheter en Thaïlande et à Bali.",
    showcaseSaleSubtext: "Une sélection de biens à vendre réels, actuellement en ligne — Thaïlande et Bali pour l'instant.",
