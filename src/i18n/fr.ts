...
export const fr: Dict = {
  ...
  invest: {
    ...
    title: "Acheter des parts de biens locatifs aux États-Unis",
    subtitle: "À partir de 50 $ la part. Vous achetez directement auprès de la plateforme, nous ne touchons jamais votre argent.",
