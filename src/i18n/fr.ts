...
export const fr: Dict = {
  ...
  invest: {
    ...
    subtitle: "Nous rassemblons des moyens d'acheter des parts de biens locatifs à partir de petites sommes. Vous achetez directement auprès de la plateforme vers laquelle nous vous redirigeons : nous ne collectons jamais votre argent.",
    fractionalTitle: "Choisissez votre plan : de quelques dizaines à quelques centaines de dollars",
    fractionalBody: "Vous achetez des parts d'un bien locatif (y compris des locations saisonnières) et vous recevez une partie de ses loyers. Commencez avec 100 $, 500 $ ou plus, répartissez sur plusieurs biens, et regardez ce que la plateforme propose à Miami.",
    minLabel: "Minimum",
    incomeLabel: "Revenus",
    loftyDesc: "Parts (tokens) de maisons et d'appartements locatifs aux États-Unis, dont des locations saisonnières. Vérifiez les biens disponibles à Miami.",
    loftyMin: "50 $ par part",
    loftyEligibility: "Ouvert au monde entier (hors pays sous sanctions)",
    eligibilityLabel: "Qui peut acheter",
    openBadge: "Ouvert au monde entier",
    examplesLabel: "Exemples",
    sharesExample: "100 $ = {a} parts · 500 $ = {b} parts",
    loftyTax: "Sans numéro fiscal américain (ITIN), 30 % des revenus sont retenus à la source ; 15 % est possible avec un ITIN et le formulaire W-8BEN.",
    oppTitle: "Des biens américains où acheter des parts aujourd'hui",
    oppBody: "Une sélection de biens actuellement proposés sur Lofty qui versent déjà des loyers. Chaque fiche renvoie vers la page du bien chez Lofty.",
    airbnbBadge: "Location saisonnière (Airbnb)",
    kindSingle: "Maison individuelle",
    kindMulti: "Immeuble multi-logements",
    kindCommercial: "Local commercial",
    kindOther: "Bien locatif",
    sharePriceLabel: "Prix de la part",
    currentYieldLabel: "Rendement actuel (selon Lofty)",
    oppNote: "Chiffres relevés chez Lofty le {date} et mis à jour toutes les 6 heures. Le rendement actuel est celui affiché par Lofty sur les loyers récents : ce n'est pas une garantie. Nous ne montrons que les biens qui versent des loyers aujourd'hui et écartons les rendements supérieurs à 12 %, souvent temporaires.",
    plansNote: "Les montants sont en dollars américains ; la valeur en euros dépend du taux de change. Les rendements annoncés sont des objectifs : les revenus réellement versés peuvent être bien inférieurs, voire nuls. Conditions d'accès selon les plateformes et des avis indépendants en 2026 — confirmez sur le site de la plateforme avant d'acheter des parts.",
    income: "Loyers versés régulièrement, non garantis",
