...
export const de: Dict = {
  ...
  invest: {
    ...
    subtitle: "Wir sammeln Möglichkeiten, ab kleinen Beträgen Anteile an Mietobjekten zu kaufen. Sie kaufen direkt bei der Plattform, zu der wir Sie weiterleiten: Wir nehmen nie Ihr Geld entgegen.",
    fractionalTitle: "Wählen Sie Ihren Plan: von wenigen Dutzend bis einigen hundert Dollar",
    fractionalBody: "Sie kaufen Anteile an einem Mietobjekt (auch Ferienunterkünfte) und erhalten einen Teil der Mieteinnahmen. Starten Sie mit 100 $, 500 $ oder mehr, verteilen Sie auf mehrere Objekte und sehen Sie, was die Plattform in Miami bietet.",
    minLabel: "Minimum",
    incomeLabel: "Erträge",
    loftyDesc: "Anteile (Token) an Miet-Häusern und -Wohnungen in den USA, auch Ferienunterkünfte. Prüfen Sie, welche Objekte in Miami verfügbar sind.",
    loftyMin: "50 $ pro Anteil",
    loftyEligibility: "Weltweit offen (außer sanktionierte Länder)",
    eligibilityLabel: "Wer kaufen kann",
    openBadge: "Weltweit offen",
    examplesLabel: "Beispiele",
    sharesExample: "100 $ = {a} Anteile · 500 $ = {b} Anteile",
    loftyTax: "Ohne US-Steuernummer (ITIN) werden 30 % der Erträge an der Quelle einbehalten; mit ITIN und Formular W-8BEN sind 15 % möglich.",
    oppTitle: "US-Objekte, bei denen Sie heute Anteile kaufen können",
    oppBody: "Eine Auswahl derzeit bei Lofty angebotener Objekte, die bereits Miete zahlen. Jede Karte führt zur Seite des Objekts bei Lofty.",
    airbnbBadge: "Ferienunterkunft (Airbnb)",
    kindSingle: "Einfamilienhaus",
    kindMulti: "Mehrfamilienhaus",
    kindCommercial: "Gewerbeobjekt",
    kindOther: "Mietobjekt",
    sharePriceLabel: "Anteilspreis",
    currentYieldLabel: "Aktuelle Rendite (laut Lofty)",
    oppNote: "Zahlen von Lofty am {date} gelesen und alle 6 Stunden aktualisiert. Die aktuelle Rendite ist die von Lofty auf Basis der jüngsten Mieten angezeigte: keine Garantie. Wir zeigen nur Objekte, die heute Miete zahlen, und lassen Renditen über 12 % weg, die oft nur vorübergehend sind.",
    plansNote: "Beträge in US-Dollar; der Euro-Wert hängt vom Wechselkurs ab. Angegebene Renditen sind Ziele: die tatsächlich ausgezahlten Erträge können deutlich niedriger oder null sein. Zugangsbedingungen laut Plattformen und unabhängigen Bewertungen 2026 — vor dem Kauf auf der Plattform bestätigen.",
    income: "Regelmäßig ausgezahlte Mieteinnahmen, nicht garantiert",
