...
export const de: Dict = {
  ...
  landing: {
    ...
    showcaseBadge: "Echte Angebote",
    showcaseTitle: "Schon heute erschwinglich, in vier Märkten.",
    showcaseSubtext: "Eine Auswahl echter, aktuell online stehender Mietangebote — sie zeigt, was wirklich erschwinglich ist, nicht nur die Prachtvillen.",
