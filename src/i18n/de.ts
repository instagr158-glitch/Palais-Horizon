...
export const de: Dict = {
  ...
  pricing: {
    ...
    features: [
      "Anteile für unter 50 $ an über 15 Objekten (Miami, Florida, Airbnb…)",
      "Direkter Zugang zu jedem Objekt: ein Klick zum Anteilskauf",
      "Aktuelle Renditen und Anzahl der Investoren je Objekt",
      "Kompletter Residenzkatalog: Thailand, Bali, Dubai, Miami",
      "Preise, exakte Lagen, Karte und vollständige Fotogalerien",
      "Direkte Vermittlung an das Maklerbüro",
      "Unbegrenzte Suchen und Filter, Favoriten",
      "Neue Objekte und Chancen, sobald sie erscheinen",
    ],
    notConfigured:
