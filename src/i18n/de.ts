...
export const de: Dict = {
  ...
  invest: {
    ...
    fractionalBody: "Sie kaufen Anteile an einem Mietobjekt (auch Ferienunterkünfte) und erhalten einen Teil der Mieteinnahmen. Starten Sie mit 100 $, 500 $ oder mehr, verteilen Sie auf mehrere Objekte und sehen Sie, was jede Plattform in Miami bietet.",
    minLabel: "Minimum",
    incomeLabel: "Erträge",
    ...
    usOnlyEligibility: "Nur für Einwohner der USA",
    eligibilityLabel: "Wer kaufen kann",
    openBadge: "Weltweit offen",
    usBadge: "Nur US-Einwohner",
