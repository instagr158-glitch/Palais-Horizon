...
export const de: Dict = {
  ...
  paris: {
    navLabel: "Wohnungen",
    badge: "Mieten in Paris",
    titleLead: "Finden Sie Ihre Wohnung in Paris",
    ...
    step2Body: "Miete, Fläche und Preis pro m² nebeneinander, um den besten Preis zu finden.",
    step3Title: "Makler kontaktieren",
    step3Body: "Ein Klick und Sie sind direkt beim Makler auf der Anzeige.",
    filterAll: "Alle",
    filterUnder: "Unter 1.200 €",
    filterMid: "1.200 – 2.000 €",
    filterPremium: "Gehoben",
  ...
  invest: {
    ...
    statShareLabel: "Mindestpreis pro Anteil",
  ...
  pricing: {
    ...
    features: [
      ...
      "Budgetfilter, Sortierung und Favoriten",
      "Neue Wohnungen, sobald sie erscheinen",
    ],
    notConfigured:
    ...
    lockedPartsBanner:
      "Anzeigen sind Mitgliedern vorbehalten. Wählen Sie unten einen Tarif, um Zugang zu erhalten.",
    lockedBanner:
