...
export const de: Dict = {
  ...
  landing: {
    ...
    showcaseSaleTitle: "Kaufen in Thailand und auf Bali.",
    showcaseSaleSubtext: "Eine Auswahl echter, aktuell online stehender Kaufimmobilien — vorerst Thailand und Bali.",
