export const en = {
  ...
  invest: {
    ...
    subtitle: "We gather ways to buy shares of rental properties, starting from small amounts. You buy directly from the platform we send you to: we never collect your money.",
    fractionalTitle: "Pick a plan: from a few dozen dollars to a few hundred",
    fractionalBody: "You buy shares of a rental property (including vacation rentals) and receive a share of its rental income. Start with $100, $500 or more, spread it over several properties, and see what the platform offers in Miami.",
    minLabel: "Minimum",
    incomeLabel: "Income",
    loftyDesc: "Shares (tokens) of rental homes and apartments in the US, including vacation rentals. Check which properties are available in Miami.",
    loftyMin: "$50 per share",
    loftyEligibility: "Open worldwide (except sanctioned countries)",
    eligibilityLabel: "Who can buy",
    openBadge: "Open worldwide",
    examplesLabel: "Examples",
    sharesExample: "$100 = {a} shares · $500 = {b} shares",
    loftyTax: "Without a US tax number (ITIN), 30% of the income is withheld at source; 15% is possible with an ITIN and form W-8BEN.",
    oppTitle: "US properties where you can buy shares today",
    oppBody: "A selection of properties currently offered on Lofty that already pay rent. Each card links to the property's page on Lofty.",
    airbnbBadge: "Vacation rental (Airbnb)",
    kindSingle: "Single-family home",
    kindMulti: "Multi-unit building",
    kindCommercial: "Commercial property",
    kindOther: "Rental property",
    sharePriceLabel: "Share price",
    currentYieldLabel: "Current yield (per Lofty)",
    oppNote: "Figures read from Lofty on {date} and refreshed every 6 hours. The current yield is the one Lofty displays based on recent rent: it is not a guarantee. We only show properties paying rent today and leave out yields above 12 %, which are often temporary.",
    plansNote: "Amounts are in US dollars; the euro value depends on the exchange rate. Announced yields are targets: the income actually paid can be much lower, or nil. Eligibility as reported by the platforms and independent reviews in 2026 — confirm on the platform's site before buying shares.",
    income: "Rental income paid regularly, not guaranteed",
