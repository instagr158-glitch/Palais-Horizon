export const en = {
  ...
  pricing: {
    ...
    features: [
      "Buy shares from under $50 in 15+ properties (Miami, Florida, Airbnb…)",
      "Direct access to each property: one click to buy your shares",
      "Current yields and investor count for every property",
      "Full residences catalogue: Thailand, Bali, Dubai, Miami",
      "Prices, exact locations, map and complete photo galleries",
      "Direct introduction to the listing agency",
      "Unlimited searches and filters, favourites",
      "New properties and opportunities as soon as they land",
    ],
    notConfigured:
