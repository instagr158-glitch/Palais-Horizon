export const en = {
  ...
  paris: {
    navLabel: "Apartments",
    badge: "Paris rentals",
    titleLead: "Find your Paris apartment",
    ...
    step2Title: "Compare",
    step2Body: "Rent, size and price per m² side by side to spot the best price.",
    step3Title: "Contact the agency",
    step3Body: "One click and you are on the listing, straight at the agency.",
    filterAll: "All",
    filterUnder: "Under €1,200",
    filterMid: "€1,200 – €2,000",
    filterPremium: "High-end",
  ...
  invest: {
    ...
    step1Title: "Pick a property",
    step1Body: "Photos, share price and displayed yield.",
    step2Title: "Buy shares",
    step2Body: "From $50, directly from the platform.",
    step3Title: "Get your share of the rent",
    step3Body: "Paid once the property earns rent.",
    badge: "Buy shares",
  ...
  pricing: {
    ...
    features: [
      ...
      "Budget filters, sorting and favourites",
      "New apartments as soon as they land",
    ],
    notConfigured:
    ...
    lockedPartsBanner:
      "Listings are for members only. Choose a plan below to get access.",
    lockedBanner:
