export const en = {
  ...
  landing: {
    ...
    showcaseBadge: "Real listings",
    showcaseTitle: "Accessible today, in four markets.",
    showcaseSubtext: "A handful of real, currently-listed rentals — priced to show what's actually reachable, not just the trophy estates.",
