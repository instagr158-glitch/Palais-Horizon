export const en = {
  ...
  invest: {
    ...
    fractionalBody: "You buy shares of a rental property (including vacation rentals) and receive a share of its rental income. Start with $100, $500 or more, spread it over several properties, and see what each platform offers in Miami.",
    minLabel: "Minimum",
    incomeLabel: "Income",
    ...
    usOnlyEligibility: "US residents only",
    eligibilityLabel: "Who can buy",
    openBadge: "Open worldwide",
    usBadge: "US residents only",
